...
// Array of 6 articles to create a perfect 3-column grid
const newsArticles = [
  { 
    id: 1, 
    category: "NEWS",
    date: "4/2/2026",
    title: "General Road Cleaning in Area", 
  ...
  { 
    ...
    category: "WEATHER",
    date: "4/1/2026",
    title: "Heavy Rainfall Expected This Weekend", 
    description: "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.", 
    image: phoneImg 
  },
  { 
    ...
    date: "3/28/2026",
    title: "New AI Models Calibrated for NCR", 
    description: "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.", 
    image: phoneImg 
  },
  { 
    ...
    category: "NEWS",
    date: "3/25/2026",
    title: "City Council Reviews Flood Defense", 
    description: "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.", 
    image: phoneImg 
  },
  { 
    ...
    <div className="min-h-screen bg-[#F8F9FA] font-sans text-black flex flex-col">
      ...
      {!hideLoader && (
        ...
        >
          ...
          {/* 3. News Grid Skeleton (Matches your exact padding and layout) */}
          <div className="w-full" style={{paddingTop:'100px',paddingBottom:'150px', paddingRight:'250px', paddingLeft:'250px'}}>
            <div className="max-w-[1920px] w-full mx-auto px-6 md:px-8">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-y-15 gap-x-10">
                ...
                {/* We generate 6 blank skeleton cards */}
                {[1, 2, 3, 4, 5, 6].map((item) => (
                  <div key={item} className="bg-white rounded-2xl overflow-hidden flex flex-col border border-gray-100 h-[460px]">
                    ...
                    <div className="p-8 flex flex-col gap-4">
                      <div className="w-1/3 h-4 rounded shimmer mt-2"></div>
              ...
              >
                ...
                <div className="p-8 flex flex-col flex-grow">
                  ...
                  <div className="flex items-center font-bold text-[12px] md:text-sm tracking-widest mb-4">
                    <span className="text-[#f10007] uppercase" style={{marginTop:'15px'}}>{article.category}</span>
                    <span className="text-gray-300 mx-2 text-lg leading-none pb-1" style={{marginTop:'10px', marginLeft:'10px', marginRight:'10px'}} >|</span> 
                    <span className="text-gray-500" style={{marginTop:'12px'}}>{article.date}</span>
                  </div>
