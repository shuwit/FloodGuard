    ...
    >
      ...
      style={{ paddingLeft: '280px', paddingRight: '280px' }}>
        ...
        <div className="flex items-center gap-4">
          ...
          {/* 👇 NEW: Animated "Waving Border" Download Button 👇 */}
          <button className="hidden xl:flex relative w-[200px] h-[55px] overflow-hidden rounded-md p-[3px] group focus:outline-none cursor-pointer">
            {/* The Spinning Gradient Background */}
            <span className="absolute inset-[-1000%] animate-[spin_3s_linear_infinite] bg-[conic-gradient(from_90deg_at_50%_50%,#e0f2fe_0%,#0863c1_50%,#e0f2fe_100%)]" />
            {/* The Solid Inner Button (Masks the center) */}
            <span className="relative inline-flex h-full w-full items-center justify-center rounded-[4px] bg-white group-hover:bg-blue-50 transition-colors text-[#0863c1] font-bold text-[20px] tracking-wide z-10">
              Download App
            </span>
          </button>
          ...
          <button
            ...
            className="hidden xl:block bg-[#005ec6] text-white w-[163px] h-[55px] leading-none rounded-md font-medium text-[20px] tracking-wide hover:bg-blue-800 transition-colors"
          >
            Log In
          </button>
      ...
      {isMobileMenuOpen && (
        <div className="xl:hidden absolute top-[100px] left-0 w-full bg-white shadow-xl border-t border-gray-100 flex flex-col py-4 px-8 animate-fadeIn">
          ...
          <button className="mt-8 bg-white border-2 border-[#005ec6] text-[#005ec6] py-4 rounded-md font-bold text-[20px] tracking-wide hover:bg-blue-50 transition-colors w-full">
            Download App
          </button>

          <button
            onClick={() => { setIsMobileMenuOpen(false); onLoginClick(); }}
            className="mt-4 bg-[#005ec6] text-white py-4 rounded-md font-bold text-[20px] tracking-wide hover:bg-blue-800 transition-colors w-full"
          >
            Log In
          </button>
        </div>
